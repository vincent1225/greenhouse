...
<body>
    ...
    <div class="tools">
    	<ul class="tab">
        <li id="btn1"  class="selected"><span></span>用户信息维护</li>
        </ul>
		<ul class="toolbar">
			<s:a target="popFrm" action="user_queryUI" onclick="javascript:document.getElementById('popFrm').style.height='95px';">
				<li><span>
					<img src="${pageContext.request.contextPath}/images/ico06.png" width="20"/>
					</span>查询
				</li>
			</s:a>
			<s:a target="popFrm" action="user_addUI" onclick="javascript:document.getElementById('popFrm').style.height='165px';">
				<li><span>
    ...
    <iframe  id="listFrm" name="listFrm" width="100%" height="1000px" scrolling="yes" frameborder="0" scrolling="yes" 
    	src="${pageContext.request.contextPath}/user_list.action"></iframe>
    </div>
</body>
</html>
